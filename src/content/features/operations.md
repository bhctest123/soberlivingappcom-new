...
features:
  - title: "Communication Logs"
    description: "Stay on top of each case by reviewing the integrated communications logs in our CRM."
    icon: "/images/icons/ic_communication_logs.png"
  
  - title: "Case Management Notes"
    description: "Case management sessions are key to an effective recovery plan."
    icon: "/images/icons/ic_clinical_notes.png"
  
  - title: "Community Connections"
    description: "Easily track resident connections to organizations and people throughout the community."
    icon: "/images/icons/ic_connections.png"
  
  - title: "Housing Properties"
    description: "Keep track of your housing properties with our property management system."
    icon: "/images/icons/ic_properties.png"
  
  - title: "Financials"
    description: "Each resident can access and pay their account balance through the Resident Portal."
...
additionalSections:
  - title: "Why Choose Our Operations Management System?"
    content: |
      <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 mb-8">
        <p class="text-lg text-gray-700 leading-relaxed mb-8">Effective operations management requires coordination across multiple departments and stakeholders. Our operations management features help you maintain clear communication, track important relationships, and manage financial processes efficiently.</p>
          ...
          <div class="grid md:grid-cols-2 gap-4">
            <div class="bg-white rounded-xl p-5 shadow-sm border border-blue-100">
              <div class="flex items-start">
                ...
                <div>
                  <h4 class="font-semibold text-gray-900 mb-1">Comprehensive Tracking</h4>
                  <p class="text-gray-600 text-sm">Monitor all aspects of resident care and case management</p>
                </div>
              </div>
            </div>
            <div class="bg-white rounded-xl p-5 shadow-sm border border-blue-100">
              <div class="flex items-start">
                ...
                <div>
                  <h4 class="font-semibold text-gray-900 mb-1">Financial Integration</h4>
                  <p class="text-gray-600 text-sm">Streamline billing and payment processes</p>
                </div>
              </div>
            </div>
            <div class="bg-white rounded-xl p-5 shadow-sm border border-blue-100">
              <div class="flex items-start">
                ...
                <div>
                  <h4 class="font-semibold text-gray-900 mb-1">Communication Hub</h4>
                  <p class="text-gray-600 text-sm">Centralize all communications for better coordination</p>
                </div>
              </div>
            </div>
            <div class="bg-white rounded-xl p-5 shadow-sm border border-blue-100">
              <div class="flex items-start">
                ...
                <div>
                  <h4 class="font-semibold text-gray-900 mb-1">Community Network</h4>
                  <p class="text-gray-600 text-sm">Track valuable community connections and resources</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-blue-100">
          <h3 class="text-xl font-bold text-gray-900 mb-3 flex items-center">
            <span class="w-8 h-8 bg-indigo-600 text-white rounded-lg flex items-center justify-center mr-3 text-sm font-bold">⚙️</span>
            Operational Excellence
          </h3>
          <p class="text-gray-700 leading-relaxed">Our operations management system integrates with all other platform features to provide a complete view of your facility operations, helping you deliver better outcomes for your residents.</p>
        </div>
      </div>
