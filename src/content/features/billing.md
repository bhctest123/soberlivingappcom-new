...
features:
  - title: "Digital Invoices"
    description: "Simplify your rent billing process using our integrated billing solution which generates invoices to send to your residents or their families."
    icon: "/images/icons/ic_invoices.png"
  
  - title: "Online Payment Collections"
    description: "Streamline the collections process by allowing residents or their families to make payments online."
    icon: "/images/icons/ic_online_payment.png"
  
  - title: "Payment Tracking"
    description: "Monitor payment status in real-time with comprehensive dashboards and automated notifications."
    icon: "/images/icons/ic_financials.png"
  
  - title: "Family Payment Portal"
    description: "Dedicated portal allowing family members to view invoices and make payments securely on behalf of residents."
    icon: "/images/icons/portal.png"

additionalSections:
  - title: "Streamlined Collections Process"
    content: |
      <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 mb-8">
        <p class="text-lg text-gray-700 leading-relaxed mb-8">Our billing system is designed specifically for sober living operations where payment complexity often involves multiple parties. Whether residents pay directly or family members handle payments, our platform accommodates all scenarios seamlessly.</p>
          ...
          <div class="grid md:grid-cols-2 gap-4">
            <div class="bg-white rounded-xl p-5 shadow-sm border border-blue-100">
              <div class="flex items-start">
                ...
                <div>
                  <h4 class="font-semibold text-gray-900 mb-1">Multi-Party Billing</h4>
                  <p class="text-gray-600 text-sm">Support for resident and family member payment arrangements</p>
                </div>
              </div>
            </div>
            <div class="bg-white rounded-xl p-5 shadow-sm border border-blue-100">
              <div class="flex items-start">
                ...
                <div>
                  <h4 class="font-semibold text-gray-900 mb-1">Automated Invoicing</h4>
                  <p class="text-gray-600 text-sm">Schedule recurring invoices for rent and additional services</p>
                </div>
              </div>
            </div>
            <div class="bg-white rounded-xl p-5 shadow-sm border border-blue-100">
              <div class="flex items-start">
                ...
                <div>
                  ...
                  <p class="text-gray-600 text-sm">Flexible payment scheduling to accommodate different financial situations</p>
                </div>
              </div>
            </div>
            <div class="bg-white rounded-xl p-5 shadow-sm border border-blue-100">
              <div class="flex items-start">
                ...
                <div>
                  <h4 class="font-semibold text-gray-900 mb-1">Late Fee Management</h4>
                  <p class="text-gray-600 text-sm">Automated late fee calculations and notifications</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-blue-100">
          ...
          <p class="text-gray-700 leading-relaxed">All payment processing is PCI compliant with bank-level security. We support multiple payment methods including credit cards, ACH transfers, and digital wallets.</p>
        </div>
      </div>
